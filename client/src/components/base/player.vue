<template>
    <section v-if="track" class="player-container">
        ...
        <div>
            <img class="curr-song" :src="track.imgUrl">
        </div>
        <div>
            <div class="flex center player-song-controllers">
                <button @click="shuffle"><span v-html="shuffleSvg"></span></button>
                <button><span v-html="prevSvg"></span></button>
                <button @click="toggleSongPlay"><span v-html="(isPlayOrPause)? pauseSvg  : playSvg"></span></button>
                <button><button><span v-html="nextSvg"></span></button></button>
